...
REM --------------------------------------------------
echo    10) show unconfigured deck (status: no-content)
...
echo.
echo.
echo    a) should fail and show original from before:
...
echo.
echo.
echo    b) should fail ... only 3 cards set
...
echo.   a) show unconfigured user data
...
echo.
echo    c) show configured user data
curl -X GET http://localhost:10001/users/kienboec --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/users/altenhof --header "Authorization: Basic altenhof-mtcgToken"
echo.
...
echo.
echo.
echo    a) check trading deals
curl -X GET http://localhost:10001/tradings  --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/tradings  --header "Authorization: Basic altenhof-mtcgToken"
echo.
echo.
echo    b) try to trade with yourself (should fail)
...
echo.
echo.
echo    d) show tradings (should be deleted)
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic altenhof-mtcgToken"
echo.
