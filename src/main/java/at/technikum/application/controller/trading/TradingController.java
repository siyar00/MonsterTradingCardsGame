...
public class TradingController implements Controller {
    ...
    public List<Pair<RouteIdentifier, Route>> listRoutes() {
        ...
        routes.add(new Pair<>(new RouteIdentifier("/tradings/{tradingdealid}", "DELETE"), this::deleteTradingDeal));
        routes.add(new Pair<>(new RouteIdentifier("/tradings/{tradingdealid}", "POST"), this::startTrading));
        return routes;
    }
